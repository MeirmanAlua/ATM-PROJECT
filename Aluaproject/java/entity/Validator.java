...
public class Validator { // create class Validator
    ...
    public static boolean validateCardNumber(int cardNUmber) {// method validateCardNumber to identify  type of card
     int visa = cardNUmber/10000000; // visa should be divisible to this number
